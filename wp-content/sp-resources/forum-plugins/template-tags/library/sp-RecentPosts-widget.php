<?php
/*
$LastChangedDate: 2013-08-23 18:22:34 -0700 (Fri, 23 Aug 2013) $
$Rev: 10574 $
*/
...
class sp_RecentPostsWidget extends WP_Widget {
	function sp_RecentPostsWidget() {
		$widget_ops = array('classname' => 'spRecentPostsWidget', 'description' => __('A widget to list the latest Simple:Press topics with recent posts', 'sp-ttags'));
		$control_ops = array('width' => 400, 'height' => 350);
		$this->WP_Widget('spf', __('Recent Forum Posts', 'sp-ttags'), $widget_ops, $control_ops);
	}
	...
	function update($new_instance, $old_instance) {
		...
		$instance['title']			= sp_filter_title_display($new_instance['title']);
		...
		$instance['beforeForum']	= sp_filter_title_display($new_instance['beforeForum']);
		$instance['afterForum']		= sp_filter_title_display($new_instance['afterForum']);
		$instance['beforeTopic']	= sp_filter_title_display($new_instance['beforeTopic']);
		$instance['afterTopic']		= sp_filter_title_display($new_instance['afterTopic']);
		$instance['beforeUser']		= sp_filter_title_display($new_instance['beforeUser']);
		$instance['afterUser']		= sp_filter_title_display($new_instance['afterUser']);
		$instance['beforeDate']		= sp_filter_title_display($new_instance['beforeDate']);
		$instance['afterDate']		= sp_filter_title_display($new_instance['afterDate']);
...
?>
		...
		<td><input style="width: 190px;" type="text" id="<?php echo $this->get_field_id('beforeForum'); ?>" name="<?php echo $this->get_field_name('beforeForum'); ?>" value="<?php echo $beforeForum ?>"/></td>
		<td><input style="width: 190px;" type="text" id="<?php echo $this->get_field_id('afterForum'); ?>" name="<?php echo $this->get_field_name('afterForum'); ?>" value="<?php echo $afterForum ?>"/></td>
		</tr>

		<tr><td><?php _e('Before Topic Text', 'sp-ttags')?>:</td><td><?php _e('After Topic Text', 'sp-ttags')?>:</td></tr>
		<td><input style="width: 190px;" type="text" id="<?php echo $this->get_field_id('beforeTopic'); ?>" name="<?php echo $this->get_field_name('beforeTopic'); ?>" value="<?php echo $beforeTopic ?>"/></td>
		<td><input style="width: 190px;" type="text" id="<?php echo $this->get_field_id('afterTopic'); ?>" name="<?php echo $this->get_field_name('afterTopic'); ?>" value="<?php echo $afterTopic ?>"/></td>
		<tr>

		<tr><td><?php _e('Before User Text', 'sp-ttags')?>:</td><td><?php _e('After User Text', 'sp-ttags')?>:</td></tr>
		<td><input style="width: 190px;" type="text" id="<?php echo $this->get_field_id('beforeUser'); ?>" name="<?php echo $this->get_field_name('beforeUser'); ?>" value="<?php echo $beforeUser ?>"/></td>
		<td><input style="width: 190px;" type="text" id="<?php echo $this->get_field_id('afterUser'); ?>" name="<?php echo $this->get_field_name('afterUser'); ?>" value="<?php echo $afterUser ?>"/></td>
		<tr>

		<tr><td><?php _e('Before Date Text', 'sp-ttags')?>:</td><td><?php _e('After Date Text', 'sp-ttags')?>:</td></tr>
		<td><input style="width: 190px;" type="text" id="<?php echo $this->get_field_id('beforeDate'); ?>" name="<?php echo $this->get_field_name('beforeDate'); ?>" value="<?php echo $beforeDate ?>"/></td>
		<td><input style="width: 190px;" type="text" id="<?php echo $this->get_field_id('afterDate'); ?>" name="<?php echo $this->get_field_name('afterDate'); ?>" value="<?php echo $afterDate ?>"/></td>
		<tr>
		...
		<tr><td width='33%'><small><b>F</b> - <?php _e('Displays forum name', 'sp-ttags')?></small></td>
		<td width='33%'><small><b>T</b> - <?php _e('Displays Topic name', 'sp-ttags')?></small></td>
