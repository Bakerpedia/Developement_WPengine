...
Simple:Press Versions: 5.1 and above
...
define('SPTTDIR', 		SFPLUGINDIR.'template-tags/');
define('SPTEMPTAGSDIR',	SFPLUGINDIR.'template-tags/library/');
...
include_once(SPTEMPTAGSDIR.'sp-RecentPosts-widget.php');
...
function sp_ForumHomeLinkTag($args='') {
    include_once(SPTEMPTAGSDIR.'sp-ForumHomeLink-tag.php');
...
function sp_GroupLinkTag($args='') {
    include_once(SPTEMPTAGSDIR.'sp-GroupLink-tag.php');
...
function sp_ForumLinkTag($args='') {
    include_once(SPTEMPTAGSDIR.'sp-ForumLink-tag.php');
...
function sp_TopicLinkTag($args='') {
    include_once(SPTEMPTAGSDIR.'sp-TopicLink-tag.php');
...
function sp_AddNewTopicLinkTag($args='') {
    include_once(SPTEMPTAGSDIR.'sp-AddNewTopicLink-tag.php');
...
function sp_ForumDropdownTag($args='') {
    include_once(SPTEMPTAGSDIR.'sp-ForumDropdown-tag.php');
...
function sp_RecentPostsTag($args='') {
    include_once(SPTEMPTAGSDIR.'sp-RecentPosts-tag.php');
...
function sp_LatestPostsTag($args='') {
    include_once(SPTEMPTAGSDIR.'sp-LatestPosts-tag.php');
...
function sp_TodaysPostsTag($args='') {
    include_once(SPTEMPTAGSDIR.'sp-TodaysPosts-tag.php');
...
function sp_AdminModeratorOnlineTag($args='') {
    include_once(SPTEMPTAGSDIR.'sp-AdminModeratorOnline-tag.php');
...
function sp_ProfileLinkTag($args='') {
    include_once(SPTEMPTAGSDIR.'sp-ProfileLink-tag.php');
...
function sp_ShowForumRankTag($userid, $args='') {
    include_once(SPTEMPTAGSDIR.'sp-ShowForumRank-tag.php');
...
function sp_ShowSpecialRanksTag($userid, $args='') {
    include_once(SPTEMPTAGSDIR.'sp-ShowSpecialRanks-tag.php');
...
function sp_SideDashTag($args='') {
    include_once(SPTEMPTAGSDIR.'sp-SideDash-tag.php');
...
function sp_HotTopicsTag($args='') {
    include_once(SPTEMPTAGSDIR.'sp-HotTopics-tag.php');
