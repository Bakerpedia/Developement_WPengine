<?php  /* Template Name: FeaturedHealthyBakingPost */ ?>
<?php 
...
<?php $megamag_options_post = get_option('megamag_options_post') ?>
		...
		<div id="main" class="container">
			...
			<div id="content">
			<!-- get featured Healthy Baking post (CUSTOM KEVIN H.)-->			
			<?php
			global $more;
			$more = 0;
			query_posts('cat=36'); 
			...
			?>
			<h1 class="blog-heading">Featured Healthy Baking Post</h1>
			...
			wp_reset_query();
			?>
			<!-- END get featured Healthy Baking post (CUSTOM KEVIN H.)-->	
