...
<head>
	...
	<!--KJH added 02/05/2015 for site traffic tracking -->
	<script src="http://js.cdn.deximedia.com/dexitracker.js"></script>
			...
			?>	
				...
				<div id="header-wrapper">
					...
					<div class="container">
						...
						<!-- KJH 1/1/15 only show the banner on the home page -->
						<?php 
						 if ( $postid == '2714' ) {
							...
							?>
								<div id="header-banner">
									...
									?>
									 ...
									 <a target="_blank" onclick="_gaq.push(['_trackEvent','BakeryConceptsBannerCall','clicks','BakeryConceptsBannerCall']);" 
                                        href="http://www.bakeryconcepts.net/radicalnewcontinuousmixing.html">
