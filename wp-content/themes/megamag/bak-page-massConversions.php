				  ...
				  <form method="post"> <br> 
					<table width="100%" class="frms noborders"> 
						<tbody>                          
							...
							<tr><td><input type="hidden" value="Clear form" onclick="clearform(this.form)" ></td></tr>
							<tr><td align="center"><input type="TEXT" name="val1" size="6" onfocus="clearform(this.form)"></td><td align="left" style="padding-left: 5px;">Kilograms</td></tr>
							<tr><td align="center"><input type="TEXT" name="val2" size="6" onfocus="clearform(this.form)"></td><td align="left" style="padding-left: 5px;">Ounces</td></tr>
							<tr><td align="center"><input type="TEXT" name="val3" size="6" onfocus="clearform(this.form)"></td><td align="left" style="padding-left: 5px;">Pounds</td></tr>
							<tr><td align="center"><input type="TEXT" name="val6" size="6" onfocus="clearform(this.form)"></td><td align="left" style="padding-left: 5px;">Tons</td></tr>									
							<tr>
								<td align="left"><input type="button" value="Calculate" onclick="convertform(this.form)"></td>
								<td><input align="right" type="button" value="Go Back" onclick="history.back(-1)" /></td>
							</tr>							
						</tbody>
					</table>
					</form><br> 
