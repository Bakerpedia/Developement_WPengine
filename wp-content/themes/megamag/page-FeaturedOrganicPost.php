<?php  /* Template Name: FeaturedOrganicPost */ ?>
<?php 
...
<?php $megamag_options_post = get_option('megamag_options_post') ?>
		...
		<div id="main" class="container">
			...
			<div id="content">
			<!-- get featured Organic post (CUSTOM KEVIN H.)-->			
			<?php
			global $more;
			$more = 0;
			query_posts('cat=37'); 
			...
			?>
			<h1 class="blog-heading">Featured Organic Post</h1>
			...
			wp_reset_query();
			?>
			<!-- END get featured Organic post (CUSTOM KEVIN H.)-->	
