	        ...
	        <?php endif; ?>  
				...
				<div class="widget2" style="padding-right: 30px;">
					...
					<form role="search" method="get" id="searchform" action="<?php echo home_url( '/' ); ?>">
					    <div>
					        <input style="font-weight:bolder; color:#000000;" type="text" value="<?php _e('What baking problems can we solve today?', 'lcz_megamag'); ?>" name="s" id="s" onfocus="if(this.value == this.defaultValue) this.value = ''"/>
