<?php  /* Template Name: FeaturedPastriesPost */ ?>
<?php 
...
<!-- get featured pastries post (CUSTOM KEVIN H.)-->			
			<?php
			global $more;
			$more = 0;
			query_posts('cat=32'); 
			...
			?>
			<h1 class="blog-heading">Featured Pastries Post</h1>
			...
			wp_reset_query();
			?>
			<!-- END get featured pastries post (CUSTOM KEVIN H.)-->
