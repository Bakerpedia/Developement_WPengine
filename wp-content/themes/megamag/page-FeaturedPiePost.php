<?php  /* Template Name: FeaturedPiePost */ ?>
<?php 
...
<?php $megamag_options_post = get_option('megamag_options_post') ?>
		...
		<div id="main" class="container">
			...
			<div id="content">
				<!-- get featured pie post (CUSTOM KEVIN H.)-->			
			<?php
			global $more;
			$more = 0;
			query_posts('cat=33'); 
			...
			?>
			<h1 class="blog-heading">Featured Pie Post</h1>
			...
			wp_reset_query();
			?>
			<!-- END get featured pie post (CUSTOM KEVIN H.)-->
