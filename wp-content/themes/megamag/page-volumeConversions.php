<?php  /* Template Name: volumeConversion */ ?>
<style>
...
<?php get_header(); ?>		
		<div id="main" class="container">		
			<div id="content">
           <h1 class="blog-heading">Volume Conversions</h1>
			
			 <div class="resp_code" align="left">							 
				<div align="left">				
				<p><b>Enter your quantity into the appropriate field and click Calculate.</b></p>				
				  <form method="post"> 
					<table width="100%" class="frms noborders"> 
						<tbody>                          
							...
							<tr style="height:25px;"><td align="center"><input type="TEXT" name="val1" size="6" onfocus="clearform(this.form)"></td><td align="left" style="padding-left: 5px;">Liters</td></tr>
							...
							<tr style="height:25px;"><td align="center"><input type="TEXT" name="val3" size="6" onfocus="clearform(this.form)"></td><td align="left" style="padding-left: 5px;">Quarts</td></tr>
							<tr style="height:25px;"><td align="center"><input type="TEXT" name="val4" size="6" onfocus="clearform(this.form)"></td><td align="left" style="padding-left: 5px;">Gallons</td></tr>									
...
document.forms[0].val2.factor = 33.8239926;
document.forms[0].val3.factor = 1.056998;
document.forms[0].val4.factor = 0.2642499;
