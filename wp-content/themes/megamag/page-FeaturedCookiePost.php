<?php  /* Template Name: FeaturedCookiePost */ ?>
<?php 
...
<?php $megamag_options_post = get_option('megamag_options_post') ?>
		...
		<div id="main" class="container">
			...
			<div id="content">
			<!-- get featured cookie post (CUSTOM KEVIN H.)-->			
			<?php
			global $more;
			$more = 0;
			query_posts('cat=30'); 
			...
			?>
			<h1 class="blog-heading">Featured Cookie Post</h1>
			...
			wp_reset_query();
			?>
			<!-- END get featured cookie post (CUSTOM KEVIN H.)-->	
