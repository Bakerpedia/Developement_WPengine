<?php  /* Template Name: FeaturedGlutenFreePost */ ?>
<?php 
...
<!-- get featured gluten free post (CUSTOM KEVIN H.)-->			
			<?php
			global $more;
			$more = 0;
			query_posts('cat=35'); 
			...
			?>
			<h1 class="blog-heading">Featured Gluten Free Post</h1>
			...
			wp_reset_query();
			?>
			<!-- END get featured gluten free post (CUSTOM KEVIN H.)-->	
