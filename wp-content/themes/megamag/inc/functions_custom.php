...
FUNCTIONS
	...
	function mb_get_google_webfonts_from_file ($file) {
	...
	function mb_make_excerpt($string, $maxlen, $split_by_word) 
	...
	function mb_google_analytics ($google_analytics_code) {
...
/****************************************************
mb_get_google_webfonts_from_file
****************************************************/

	//needs full url so use something like $data = mb_get_google_webfonts_from_file(get_template_directory_uri() . '/inc/webfonts.txt');
	function mb_get_google_webfonts_from_file ($file) {
...
****************************************************/
	...
	function mb_localize_datetime($datetime) {
		$datetime = str_replace('January', __('January', 'lcz_megamag'), $datetime);
		$datetime = str_replace('February', __('February', 'lcz_megamag'), $datetime);
		$datetime = str_replace('March', __('March', 'lcz_megamag'), $datetime);
		$datetime = str_replace('April', __('April', 'lcz_megamag'), $datetime);
		$datetime = str_replace('May', __('May', 'lcz_megamag'), $datetime);
		$datetime = str_replace('June', __('June', 'lcz_megamag'), $datetime);
		$datetime = str_replace('July', __('July', 'lcz_megamag'), $datetime);
		$datetime = str_replace('August', __('August', 'lcz_megamag'), $datetime);
		$datetime = str_replace('September', __('September', 'lcz_megamag'), $datetime);
		$datetime = str_replace('October', __('October', 'lcz_megamag'), $datetime);
		$datetime = str_replace('November', __('November', 'lcz_megamag'), $datetime);
		$datetime = str_replace('December', __('December', 'lcz_megamag'), $datetime);

		$datetime = str_replace('Jan', __('Jan', 'lcz_megamag'), $datetime);
		$datetime = str_replace('Feb', __('Feb', 'lcz_megamag'), $datetime);
		$datetime = str_replace('Mar', __('Mar', 'lcz_megamag'), $datetime);
		$datetime = str_replace('Apr', __('Apr', 'lcz_megamag'), $datetime);
		$datetime = str_replace('May', __('May', 'lcz_megamag'), $datetime);
		$datetime = str_replace('Jun', __('Jun', 'lcz_megamag'), $datetime);
		$datetime = str_replace('Jul', __('Jul', 'lcz_megamag'), $datetime);
		$datetime = str_replace('Aug', __('Aug', 'lcz_megamag'), $datetime);
		$datetime = str_replace('Sep', __('Sep', 'lcz_megamag'), $datetime);
		$datetime = str_replace('Oct', __('Oct', 'lcz_megamag'), $datetime);
		$datetime = str_replace('Nov', __('Nov', 'lcz_megamag'), $datetime);
		$datetime = str_replace('Dec', __('Dec', 'lcz_megamag'), $datetime);

		$datetime = str_replace('Monday', __('Monday', 'lcz_megamag'), $datetime);
		$datetime = str_replace('Tuesday', __('Tuesday', 'lcz_megamag'), $datetime);
		$datetime = str_replace('Wednesday', __('Wednesday', 'lcz_megamag'), $datetime);
		$datetime = str_replace('Thursday', __('Thursday', 'lcz_megamag'), $datetime);
		$datetime = str_replace('Friday', __('Friday', 'lcz_megamag'), $datetime);
		$datetime = str_replace('Saturday', __('Saturday', 'lcz_megamag'), $datetime);
		$datetime = str_replace('Sunday', __('Sunday', 'lcz_megamag'), $datetime);

		$datetime = str_replace('Mon', __('Mon', 'lcz_megamag'), $datetime);
		$datetime = str_replace('Tue', __('Tue', 'lcz_megamag'), $datetime);
		$datetime = str_replace('Wed', __('Wed', 'lcz_megamag'), $datetime);
		$datetime = str_replace('Thu', __('Thu', 'lcz_megamag'), $datetime);
		$datetime = str_replace('Fri', __('Fri', 'lcz_megamag'), $datetime);
		$datetime = str_replace('Sat', __('Sat', 'lcz_megamag'), $datetime);
		$datetime = str_replace('Sun', __('Sun', 'lcz_megamag'), $datetime);
...
****************************************************/
	...
	function mb_get_twitter_count ($twitter_screen_name) {
		...
		if ($twitter_count === false) {
			//echo "NEW RUN!<br>";
			if (isset($megamag_options_post['oauth_access_token']['screen_name'])) {
				$access_token = $megamag_options_post['oauth_access_token'];

        		$twitteroauth = new TwitterOAuth($megamag_options_post['oauth_consumer_key'], $megamag_options_post['oauth_consumer_secret'], $access_token['oauth_token'], $access_token['oauth_token_secret']);
    			$followers_ids = $twitteroauth->get('followers/ids');

				if ($twitteroauth->http_code  == 200) {
					$twitter_count = count($followers_ids->ids);
...
****************************************************/
	...
	//this function adds the google analytics code (called in the footer.php)
	function mb_google_analytics ($google_analytics_code) {
