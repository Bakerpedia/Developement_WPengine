					<div class="post-related">
						...
						<h1><?php _e('Bakerpedia Suggested Posts', 'lcz_megamag'); ?></h1>
							...
							if (!empty($results_related[$related_counter])) {		//if there are still related posts
								...
								if (get_the_ID() != $results_related[$related_counter]->ID) {	//if main story does not match related ?>		
									...
									<div class="related-item <?php if ($related_counter == ($num_related_posts-1)) echo "last"; ?>">
												 ...
												 <!-- <a href='<?php the_permalink($results_related[$related_counter]->ID); ?>'> -->
												 <img style="opacity:0.3;" src="https://fbcdn-profile-a.akamaihd.net/hprofile-ak-ash3/t1.0-1/p48x48/625560_149680945197188_1588695115_t.png"/></a> 
