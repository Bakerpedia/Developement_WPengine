				<h1 class="blog-heading"><?php _e("Latest Posts", "lcz_megamag"); ?></h1>
					...
					<div class="blog-item">
						...
						<?php 
							...
							if (has_post_thumbnail(get_the_ID())) { 
								...
								<a href='<?php the_permalink(); ?>'><img src="<?php echo get_template_directory_uri(); ?>/images/item-big.jpg" alt="" width="270"/></a>
							<?php
							}
