<?php  /* Template Name: FeaturedPizzaPost */ ?>
<?php 
...
<!-- get featured pizza post (CUSTOM KEVIN H.)-->			
			<?php
			global $more;
			$more = 0;
			query_posts('cat=34'); 
			...
			?>
			<h1 class="blog-heading">Featured Pizza Post</h1>
			...
			wp_reset_query();
			?>
			<!-- END get featured pizza post (CUSTOM KEVIN H.)-->	
