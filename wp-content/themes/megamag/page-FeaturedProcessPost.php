<?php  /* Template Name: FeaturedProcessPost */ ?>
<?php 
...
<?php $megamag_options_post = get_option('megamag_options_post') ?>
		...
		<div id="main" class="container">
			...
			?>
			<h1 class="blog-heading">Featured Process Post</h1>
			
			<div class="blog-item" id="">	
				<div class="archive-text" style="padding-bottom:-2px;" >
				...
				<div id="" class="blog-item" style="padding-bottom:2px;">
