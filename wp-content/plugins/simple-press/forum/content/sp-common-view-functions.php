...
$LastChangedDate: 2014-08-20 17:39:43 -0700 (Wed, 20 Aug 2014) $
$Rev: 11893 $
*/
...
function sp_GoToTop($args='', $label='', $toolTip='') {
	...
	if (!empty($icon)) $out.= "<img class='$iconClass vtip' src='".sp_find_icon(SPTHEMEICONSURL, $icon)."' alt='' title='$toolTip' />";
	$out.= "$label</a>";
	$out.= "</div>\n";
