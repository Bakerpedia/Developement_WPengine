...
$LastChangedDate: 2014-07-01 13:10:02 -0700 (Tue, 01 Jul 2014) $
$Rev: 11648 $
*/
...
function sp_ListSearchTopicHeader($args='') {
	...
	$out = "<div id='$tagId' class='$tagClass'><a class='$linkClass vtip' href='$spThisPostList->post_permalink'>$topic_name</a></div>\n";
