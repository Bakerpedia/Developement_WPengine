...
class spPostList {
	...
	function __construct($where='', $order='', $count=0, $view='forum-title') {
		$this->listData = $this->sp_postlistview_query($where, $order, $count, $view);
	...
	#
	# --------------------------------------------------------------------------------------
	function sp_postlistview_query($where, $order, $count, $view) {
