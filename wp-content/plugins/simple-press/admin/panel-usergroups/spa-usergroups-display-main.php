...
?>
			<table id="usergrouprow-<?php echo($usergroup->usergroup_id); ?>" class="wp-list-table widefat">
				<tr>
					...
					<td><span class='row-title'><strong><?php echo sp_filter_title_display($usergroup->usergroup_name); ?></strong></span><span><br /><?php echo sp_filter_title_display($usergroup->usergroup_desc); ?></span></td>
					<td width="8%" class='row-title' align="center" style="padding:10px 0;"><?php if ($usergroup->usergroup_is_moderator == 1) echo spa_etext("Yes"); else echo spa_etext("No"); ?></td>
				</tr>
...
?>
				...
				<tr class="sfinline-form"> <!-- This row will hold hidden forms for the current user group membership-->
				  	<td colspan="5" style="padding: 0 10px 0 0;">
