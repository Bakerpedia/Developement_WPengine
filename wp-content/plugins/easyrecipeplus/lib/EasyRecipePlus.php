...
EOD;
    ...
    function loadSettingsPage() {
        ...
        wp_enqueue_style("easyrecipe-settings", self::$EasyRecipePlusUrl . "/css/easyrecipe-settings.css", array('easyrecipe-UI'), self::$pluginVersion);
        wp_enqueue_style("thickbox");
        wp_enqueue_script('thickbox');
        wp_enqueue_script('easyrecipe-settings', self::$EasyRecipePlusUrl . "/js/easyrecipe-settings.js", array('jquery-ui-dialog', 'jquery-ui-slider', 'jquery-ui-autocomplete', 'jquery-ui-tabs', 'jquery-ui-button', 'thickbox'),
        ...
        if ($this->wpVersion == '-3.9') {
            ...
            wp_enqueue_script('easyrecipe-plupload', self::$EasyRecipePlusUrl . "/plupload/jquery.ui.plupload{$this->pluploadVersion}.js", array('plupload-html4', 'jquery-ui-progressbar', 'jquery-ui-button', 'jquery-ui-sortable'),
                self::$pluginVersion, true);
        }
        wp_enqueue_script('easyrecipe-import', self::$EasyRecipePlusUrl . "/js/easyrecipe-import.js", array('easyrecipe-plupload', 'easyrecipe-settings'), self::$pluginVersion, true);
    ...
    function loadPostAdmin() {
        ...
        if (empty($_REQUEST['post_type']) || $_REQUEST['post_type'] != 'soliloquy' || $_REQUEST['post_type'] != 'easyindex') {
            ...
            wp_enqueue_style("easyrecipe-UI");
            wp_enqueue_style("easyrecipe-entry", self::$EasyRecipePlusUrl . "/css/easyrecipe-entry.css", array('easyrecipe-UI'), self::$pluginVersion);

            wp_enqueue_script('jquery-ui-dialog');
            wp_enqueue_script('jquery-ui-autocomplete');
            wp_enqueue_script('jquery-ui-button');
            wp_enqueue_script('jquery-ui-tabs');
            wp_enqueue_script('easyrecipe-entry', self::$EasyRecipePlusUrl . "/js/easyrecipe-entry{$this->wpVersion}.js", array('jquery-ui-dialog', 'jquery-ui-autocomplete', 'jquery-ui-button', 'jquery-ui-tabs'), self::$pluginVersion, true);
    ...
    function enqueAdminScripts($hook) {
        if ($hook == 'edit.php' && $this->settings->gpUserID != 0) {
            ...
            wp_enqueue_style("easyrecipe-posts", self::$EasyRecipePlusUrl . "/css/easyrecipe-posts.css", array('easyrecipe-UI'), self::$pluginVersion);
            wp_enqueue_script('easyrecipe-posts', self::$EasyRecipePlusUrl . "/js/easyrecipe-posts.js", array('jquery-ui-dialog', 'jquery-ui-autocomplete', 'jquery-ui-button', 'jquery-ui-tabs'), self::$pluginVersion, true);
        }
    }
    ...
    function enqueueScripts() {
        ...
        */
        ...
        wp_enqueue_style('easyrecipestyle-reset', self::$EasyRecipePlusUrl . "/css/easyrecipe-style-reset.css", array(), self::$pluginVersion);
        ...
        wp_enqueue_script($this->pluginName, self::$EasyRecipePlusUrl . "/js/easyrecipe.js", array('jquery', 'jquery-ui-button'), self::$pluginVersion, $this->loadJSInFooter);
        ...
        if (current_user_can("edit_theme_options")) {
            ...
            */
            ...
            wp_enqueue_style("easyrecipeformat", self::$EasyRecipePlusUrl . "/css/easyrecipe-format.css", array('easyrecipe-FormatUI'), self::$pluginVersion);

            wp_enqueue_script('easyrecipeformat', self::$EasyRecipePlusUrl . "/js/easyrecipe-format.js",
    ...
    function enqueueFooderificWPPointer() {
        if (current_user_can('edit_theme_options')) {
            ...
            if (!in_array('easyrecipe-fooderific', $dismissed)) {
                ...
                wp_enqueue_script('easyrecipe-wppointer', self::$EasyRecipePlusUrl . "/js/easyrecipe-wppointer.js", array('wp-pointer'), self::$pluginVersion);
...
//                    if (!$this->settings->gpUseGravity) {
                    wp_enqueue_style("easyrecipe-guestpost", self::$EasyRecipePlusUrl . "/css/easyrecipe-guestpost.css", array(), self::$pluginVersion);
                    wp_enqueue_script('easyrecipe-guestpost', self::$EasyRecipePlusUrl . "/js/easyrecipe-guestpostdetails.js", array('jquery'), self::$pluginVersion, true);
//                    }
                    break;
                ...
                case $this->settings->gpEntryPage:
                    wp_enqueue_style("easyrecipe-UI");
                    wp_enqueue_style("easyrecipe-entry", self::$EasyRecipePlusUrl . "/css/easyrecipe-entry.css", array('easyrecipe-UI'), self::$pluginVersion);
                    wp_enqueue_style("easyrecipe-guestpost", self::$EasyRecipePlusUrl . "/css/easyrecipe-guestpost.css", array('easyrecipe-entry'), self::$pluginVersion);
                    wp_enqueue_style("easyrecipe-guestposteditor", self::$EasyRecipePlusUrl . "/css/easyrecipe-guestposteditor{$this->wpVersion}.css", array('easyrecipe-entry'), self::$pluginVersion);
                    wp_enqueue_script('plupload');
                    wp_enqueue_script('plupload-html5');
                    wp_enqueue_script('plupload-flash');
                    wp_enqueue_script('plupload-silverlight');
                    ...
                    wp_enqueue_script('easyrecipe-entry', self::$EasyRecipePlusUrl . "/js/easyrecipe-entry{$this->wpVersion}.js", array('jquery-ui-dialog', 'jquery-ui-autocomplete', 'jquery-ui-button', 'jquery-ui-tabs'), self::$pluginVersion,
                        true);
                    wp_enqueue_script('easyrecipe-guestpost', self::$EasyRecipePlusUrl . "/js/easyrecipe-guestpostentry{$this->wpVersion}.js", array('plupload', 'easyrecipe-entry', 'jquery-ui-progressbar'), self::$pluginVersion, true);
...
EOD;
        ...
        */
        if ($isPrint && current_user_can("edit_theme_options")) {
            $html .= sprintf('<script type="text/javascript" src="%s/js/easyrecipe-format.js?version=%s"></script>', self::$EasyRecipePlusUrl, self::$pluginVersion);
        }
        return $html;
    }
...
EOD;
    ...
    function mcePlugins($plugins) {
        ...
        $plugins['easyrecipe'] = self::$EasyRecipePlusUrl . "/js/easyrecipe-mce{$this->mceVersion}.js?v=" . self::$pluginVersion;
        $plugins['noneditable'] = self::$EasyRecipePlusUrl . "/tinymce/noneditable{$this->mceVersion}.js?v=" . self::$pluginVersion;
        if ($this->isGuest) {
            $plugins['guestpost'] = self::$EasyRecipePlusUrl . "/js/easyrecipe-guestpost-mce{$this->mceVersion}.js?v=" . self::$pluginVersion;
        }
        return $plugins;
    }
